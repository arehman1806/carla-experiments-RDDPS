...
class SignalizedJunctionLeftTurn(BasicScenario):
    ...
    timeout = 80000000000  # Timeout of scenario in seconds
    ...
    def _initialize_actors(self, config):
        ...
        first_vehicle = CarlaDataProvider.request_new_actor(config.other_actors[0].model, self._other_actor_transform, rolename="oncoming")

...
#             cont = false
#             skip_count = -1
#             for (i_idx, idx) in enumerate(s′i)
#                 if unevaluated_states[ai][idx] == 0 && idx != si
#                     # println("current state is $si. have to break bec Qw[$ai][$idx] has not been evaluated yet. other states: $s′i")
#                     skip_count += 1
#                     if skip_count >= skips
#                         cont = true
#                         break
